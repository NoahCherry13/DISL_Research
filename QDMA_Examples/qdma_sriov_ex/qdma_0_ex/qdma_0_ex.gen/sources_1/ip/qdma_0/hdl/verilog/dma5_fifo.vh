...
`include "dma5_axi4mm_axi_bridge.vh"
  ...
  module qdma_v4_0_8_GenericFIFO
...
`endif
  ...
  module qdma_v4_0_8_GenericFIFO2
    #(parameter BUF_DATAWIDTH = 256,
      parameter LATE_EP_ON_WR = 1,
      parameter BUF_WE = BUF_DATAWIDTH/8,
      parameter BUF_DEPTH = 512,
...
`endif
  ...
  module qdma_v4_0_8_GenericFIFOAsyncNoHead
    #(parameter BUF_DATAWIDTH = 256,
      parameter BUF_WE = BUF_DATAWIDTH/8,
      parameter BUF_DEPTH = 512,
      parameter BUF_PTR = (BUF_DEPTH <=2) ? 1:
...
`endif
  ...
  module qdma_v4_0_8_GenericFIFOAsync
    #(parameter BUF_DATAWIDTH = 256,
      parameter BUF_WE = BUF_DATAWIDTH/8,
      parameter BUF_DEPTH = 512,
      parameter BUF_PTR = (BUF_DEPTH <=2) ? 1:
...
`endif    
  ...
  module qdma_v4_0_8_GenericFIFOHead
    #(parameter BUF_DATAWIDTH = 256,
...
assign MemArrayRd = MemArray[RdPtr];
  ...
  module qdma_v4_0_8_GenericFIFOHead2
    #(parameter BUF_DATAWIDTH = 256,
      parameter TCQ = 0,
      parameter BUF_WE = BUF_DATAWIDTH/8,
      parameter BUF_DEPTH = 512,
