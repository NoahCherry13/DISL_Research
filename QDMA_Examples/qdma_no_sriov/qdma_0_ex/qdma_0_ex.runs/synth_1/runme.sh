...
HD_PWD='/home/ncherry/qdma_no_sriov/qdma_0_ex/qdma_0_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_qdma_pcie_ep.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xilinx_qdma_pcie_ep.tcl
