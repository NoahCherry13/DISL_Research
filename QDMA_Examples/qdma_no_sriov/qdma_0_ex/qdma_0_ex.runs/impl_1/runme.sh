...
HD_PWD='/home/ncherry/qdma_no_sriov/qdma_0_ex/qdma_0_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_qdma_pcie_ep.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xilinx_qdma_pcie_ep.tcl -notrace
