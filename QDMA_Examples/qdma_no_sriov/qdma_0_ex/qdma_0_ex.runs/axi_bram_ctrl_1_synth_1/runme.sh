...
HD_PWD='/home/ncherry/qdma_no_sriov/qdma_0_ex/qdma_0_ex.runs/axi_bram_ctrl_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_bram_ctrl_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_bram_ctrl_1.tcl
