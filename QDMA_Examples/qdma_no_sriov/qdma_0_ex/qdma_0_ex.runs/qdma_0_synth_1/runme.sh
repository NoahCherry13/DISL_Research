...
HD_PWD='/home/ncherry/qdma_no_sriov/qdma_0_ex/qdma_0_ex.runs/qdma_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log qdma_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source qdma_0.tcl
